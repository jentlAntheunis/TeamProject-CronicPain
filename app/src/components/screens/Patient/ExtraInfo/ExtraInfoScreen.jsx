  ...
  return (
    <ScrollableScreen className={styles.wrapper}>
      <div className="container">
        ...
        <p>
          Welkom op de &quot;Extra Info&quot; pagina van ons project! Wij zijn
          een gepassioneerd groepje MCT-studenten, gevestigd in België. Voor het
          vak Team Project hebben we de opdracht gekregen om een innovatieve
        ...
        <p>
          ...
          mentale toestand van patiënten bijhoudt, zoals hun emotionele welzijn
          en motivatie om te bewegen.
        </p>
        <p>
          ...
          actief deel te nemen aan de app. Door dit te doen, streven we ernaar
          het proces niet alleen functioneel, maar ook boeiend en plezierig te
          maken.
        </p>
        <p>
        ...
        <p>
          ...
          traject biedt niet alleen inzicht in hun eigen data, maar stimuleert
          hen ook om hun begrip van pijn te verbeteren en hen aan te moedigen
          met vertrouwen te blijven bewegen.
        </p>
